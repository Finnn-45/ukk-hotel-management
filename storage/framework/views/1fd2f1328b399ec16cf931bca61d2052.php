...
<div class="row mb-4 align-items-center">
    <div class="col-md-8">
        ...
        <p class="text-muted mb-0">Selamat datang kembali, <span class="fw-semibold text-dark"><?php echo e(auth()->user()->name); ?></span>. Berikut ringkasan performa operasional hotel Anda.</p>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color:#334155;"><?php echo e($stats['total_rooms']); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color:#334155;"><?php echo e($stats['occupied_rooms']); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color:#334155;"><?php echo e($stats['available_rooms']); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color:#334155;"><?php echo e($reports['occupancy_rate']); ?>%</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color:#334155;"><?php echo e($stats['today_bookings']); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color:#334155;"><?php echo e($stats['today_restaurant_orders']); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h4 class="fw-bold mb-0 text-success" style="font-size:1.1rem;">Rp <?php echo e(number_format($stats['today_revenue'], 0, ',', '.')); ?></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-hover h-100 shadow-sm border-0">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <h4 class="fw-bold mb-0 text-primary" style="font-size:1.1rem;">Rp <?php echo e(number_format($reports['monthly_revenue'], 0, ',', '.')); ?></h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                <?php if($reports['payment_methods']->count() > 0): ?>
    ...
    <div class="card-body p-0">
        <div class="timeline-scroll">
            <div class="timeline-grid">
                ...
                <?php $__currentLoopData = $timeline_dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateIndex => $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
                    <div class="timeline-day-header<?php echo e($classes); ?>" style="grid-row:1;grid-column:<?php echo e(2 + $dateIndex); ?>;">
                        <span class="day-name"><?php echo e($date->translatedFormat('D')); ?></span>
                        <span class="day-date"><?php echo e($date->format('d/m')); ?></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <?php $gridRowIndex = 2; ?>
                <?php $__currentLoopData = $room_types_timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roomType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="timeline-group-header" style="grid-row:<?php echo e($gridRowIndex); ?>;grid-column:1/-1;">
                        <i class="bi bi-tag-fill text-primary"></i> <span class="fw-bold"><?php echo e($roomType->name); ?> Rooms</span>
                    </div>
                    <?php $gridRowIndex++; ?>
                    <?php $__currentLoopData = $roomType->rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="timeline-room-label" style="grid-row:<?php echo e($gridRowIndex); ?>;grid-column:1;">
                            <span class="room-title">Kamar <?php echo e($room->room_number); ?></span>
                            <span class="room-floor">Lantai <?php echo e($room->floor); ?></span>
                        </div>
                        <?php $__currentLoopData = $timeline_dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateIndex => $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $isToday = $date->isToday();
                                ...
                                if ($isWeekend) $classes .= ' weekend';
                            ?>
                            <div class="timeline-cell<?php echo e($classes); ?>" style="grid-row:<?php echo e($gridRowIndex); ?>;grid-column:<?php echo e(2 + $dateIndex); ?>;"></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $room->bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($overlaps): ?>
                                ...
                                ?>
                                <a href="<?php echo e(route('admin.bookings.show', $booking->id)); ?>" class="timeline-booking-bar <?php echo e($themeClass); ?>" style="grid-row:<?php echo e($gridRowIndex); ?>;grid-column:<?php echo e($startCol); ?>/<?php echo e($endCol); ?>;" title="<?php echo e($booking->guest->full_name); ?> (<?php echo e($booking->number_of_guests); ?> Tamu)">
                                    <div class="bar-avatar"><?php echo e(strtoupper(substr($booking->guest->full_name, 0, 1))); ?></div>
                                    <span class="fw-bold text-truncate" style="max-width:90px;"><?php echo e($booking->guest->full_name); ?></span>
                                    <span class="opacity-75 d-none d-md-inline" style="font-size:0.65rem;">(<?php echo e($booking->number_of_guests); ?> Pax)</span>
                                </a>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $gridRowIndex++; ?>
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-0 py-3 d-flex align-items-center justify-content-between">
                ...
                <a href="<?php echo e(route('admin.bookings.index')); ?>" class="btn btn-sm btn-light text-primary fw-semibold px-3 rounded-pill">Lihat Semua</a>
            </div>
            <div class="card-body p-0">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-initials me-2"><?php echo e(strtoupper(substr($booking->guest->full_name ?? '?', 0, 2))); ?></div>
                                        <span class="fw-semibold text-dark"><?php echo e($booking->guest->full_name ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="fw-semibold"><?php echo e($booking->room->room_number ?? '-'); ?> - <?php echo e($booking->room->roomType->name ?? '-'); ?></td>
                                <td><?php echo e($booking->check_in ? \Carbon\Carbon::parse($booking->check_in)->format('d/m') : '-'); ?></td>
                                <td>
                                    <?php if($booking->status == 'confirmed' || $booking->status == 'checked_in'): ?>
                                        <span class="badge-premium badge-premium-success"><?php echo e(ucfirst($booking->status)); ?></span>
                                    ...
                                    <?php else: ?>
                                        <span class="badge-premium badge-premium-secondary"><?php echo e(ucfirst($booking->status)); ?></span>
                                    <?php endif; ?>
                                </td>
                            </tr>
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-0 py-3 d-flex align-items-center justify-content-between">
                ...
                <a href="<?php echo e(route('admin.restaurant.order.index')); ?>" class="btn btn-sm btn-light text-primary fw-semibold px-3 rounded-pill">Lihat Semua</a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-custom table-hover mb-0">
                        ...
                        <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recent_restaurant_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="fw-semibold"><?php echo e($order->guest->full_name ?? 'N/A'); ?></td>
                                <td>
                                    <?php if($order->details->count() > 0): ?>
                                        <?php echo e($order->details->first()->menu->name ?? '-'); ?>

                                        <?php if($order->details->count() > 1): ?>
                                            <span class="text-muted">+<?php echo e($order->details->count()-1); ?> lainnya</span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <span class="badge-premium badge-premium-<?php echo e($sc); ?>"><?php echo e(ucfirst($order->status)); ?></span>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div class="row g-4 mb-4">
            ...
            <div class="card-body">
                ...
                <div class="room-status-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <div class="room-status-item <?php echo e($statusClass); ?>" title="Kamar <?php echo e($room->room_number); ?> - <?php echo e($room->status); ?>">
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                <?php $__empty_1 = true; $__currentLoopData = $recent_reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="d-flex align-items-start gap-3 mb-3 pb-3" style="border-bottom:1px solid #F1F5F9;">
                        <div class="avatar-initials" style="width:36px;height:36px;font-size:0.7rem;"><?php echo e(strtoupper(substr($review->user->name ?? '?', 0, 2))); ?></div>
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                <strong style="font-size:0.85rem;"><?php echo e($review->user->name ?? 'Anonim'); ?></strong>
                                <span class="text-warning" style="font-size:0.75rem;">
                                    <?php for($i=1;$i<=5;$i++): ?>
                                        <?php if($i<=$review->rating): ?><i class="bi bi-star-fill"></i><?php else: ?><i class="bi bi-star"></i><?php endif; ?>
                                    <?php endfor; ?>
                                </span>
                            </div>
                            <p class="text-muted mb-0" style="font-size:0.82rem;font-style:italic;">"<?php echo e($review->message ?? $review->review ?? '-'); ?>"</p>
                            <small class="text-muted" style="font-size:0.7rem;"><?php echo e($review->created_at ? $review->created_at->diffForHumans() : ''); ?></small>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-4">
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-6">
                        <a href="<?php echo e(route('admin.bookings.create')); ?>" class="quick-action-btn"><i class="bi bi-plus-circle text-primary"></i> Tambah Booking</a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo e(route('admin.rooms.create')); ?>" class="quick-action-btn"><i class="bi bi-plus-circle text-success"></i> Tambah Kamar</a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo e(route('admin.restaurant.menu.create')); ?>" class="quick-action-btn"><i class="bi bi-plus-circle text-warning"></i> Tambah Menu</a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo e(route('admin.verify.booking.form')); ?>" class="quick-action-btn"><i class="bi bi-qr-code-scan text-danger"></i> Verifikasi Check-in</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <?php $__empty_1 = true; $__currentLoopData = $recent_activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="activity-item">
                        ...
                        <div class="flex-grow-1">
                            <div style="font-size:0.85rem;color:#334155;"><?php echo e($activity->description ?? $activity->activity ?? '-'); ?></div>
                            <div class="activity-time"><?php echo e($activity->created_at ? $activity->created_at->diffForHumans() : ''); ?></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-4">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if(weeklyCtx) {
        ...
        const days = <?php echo json_encode($reports['weekly_days']); ?>;
        const revenues = <?php echo json_encode($reports['weekly_revenue']); ?>;
    ...
    if(paymentCtx) {
        ...
        const rawLabels = <?php echo $reports['payment_methods']->pluck('payment_method')->toJson(); ?>;
        ...
        new Chart(ctx2, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    data: <?php echo $reports['payment_methods']->pluck('count'); ?>,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ukk-hotel-management\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>