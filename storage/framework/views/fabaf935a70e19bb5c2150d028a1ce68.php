...
<footer class="se-footer pt-5 pb-3 mt-5">
    <div class="container">
        <div class="row g-4 pb-4">
            <div class="col-lg-4">
                <a href="<?php echo e(route('home')); ?>" class="se-logo mb-3 d-inline-flex">
            ...
            <div class="col-6 col-lg-2">
                ...
                <a href="<?php echo e(route('home')); ?>" class="se-footer-link">Home</a>
                <a href="<?php echo e(route('rooms.index')); ?>" class="se-footer-link">Rooms</a>
                <a href="<?php echo e(route('customer.restaurant.menu')); ?>" class="se-footer-link">Restaurant</a>
                <a href="<?php echo e(route('customer.contact')); ?>" class="se-footer-link">Contact</a>
            </div>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 pt-4" style="font-size:0.8rem;">
            <p class="mb-0">&copy; <?php echo e(date('Y')); ?> StayEase. All rights reserved.</p>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\ukk-hotel-management\resources\views/customer/partials/footer.blade.php ENDPATH**/ ?>