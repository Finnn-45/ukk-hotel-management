<?php $__env->startSection('title', 'Detail Kamar - ' . $room->room_number); ?>
...
<div class="container py-3 py-md-4">
    ...
    <nav aria-label="breadcrumb" class="se-breadcrumb mb-3 mb-md-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><i class="bi bi-house"></i> Beranda</a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('rooms.index')); ?>">Kamar</a></li>
            <li class="breadcrumb-item active fw-semibold"><?php echo e($room->room_number); ?></li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            ...
            <div class="se-room-gallery mb-3 mb-lg-4">
                ...
                <div class="se-thumbnail-grid">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <img src="<?php echo e($img); ?>"
                         class="se-thumbnail"
                         alt="Thumbnail <?php echo e($index + 1); ?>"
                         onclick="document.getElementById('mainImage').src='<?php echo e($img); ?>'.replace('w=200', 'w=800')">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center gap-3 p-3 mb-3 rounded-3" style="background: var(--se-bg);">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-2 small mb-1">
                                <span class="text-muted" style="min-width: 12px;"><?php echo e($star); ?></span>
                                <div class="progress flex-grow-1" style="height: 6px;">
                                    <div class="progress-bar" style="width: <?php echo e($star == 5 ? 60 : ($star == 4 ? 25 : ($star == 3 ? 10 : ($star == 2 ? 3 : 2)))); ?>%; background-color: var(--se-accent);"></div>
                                </div>
                                <span class="text-muted" style="min-width: 30px;"><?php echo e($star == 5 ? '60%' : ($star == 4 ? '25%' : ($star == 3 ? '10%' : ($star == 2 ? '3%' : '2%')))); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="se-review-item">
                            ...
                            <p class="se-review-text"><?php echo e($review['text']); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="se-room-gallery mb-3">
                        ...
                        <div class="se-thumbnail-grid">
                            ...
                            <img src="<?php echo e($img); ?>"
                                 class="se-thumbnail"
                                 alt="Restaurant <?php echo e($index + 1); ?>"
                                 onclick="document.getElementById('restaurantMainImage').src='<?php echo e($img); ?>'.replace('w=200', 'w=800')">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <a href="<?php echo e(route('customer.restaurant.menu')); ?>" class="btn-se btn-se-primary w-100 mt-3" style="justify-content: center;">
            ...
            <div class="se-room-info-card mb-3 mb-lg-4">
                <div class="card-body">
                    ...
                    ?>
                    <?php $__currentLoopData = ['Lobby', 'Restaurant', 'Kolam Renang', 'Gym', 'Garden', 'Parking']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="se-gallery-item" data-bs-toggle="modal" data-bs-target="#galleryModal<?php echo e($index); ?>">
                            <img src="https://images.unsplash.com/photo-<?php echo e($galleryImages[$index % 6]); ?>?w=400"
                                 alt="<?php echo e($gallery); ?>">
        ...
        <div class="col-lg-4">
            ...
            <div class="se-booking-sidebar mb-3 sticky-lg-top" style="top: 76px;">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('customer.booking')); ?>" method="POST" id="bookingForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="check_in" class="form-control rounded-3" style="background: var(--se-bg); border: 1.5px solid var(--se-border); font-family: var(--font-alt, inherit);" min="<?php echo e(date('Y-m-d')); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold small">
                                <i class="bi bi-calendar me-1"></i> Check Out
                            </label>
                            <input type="date" name="check_out" class="form-control rounded-3" style="background: var(--se-bg); border: 1.5px solid var(--se-border); font-family: var(--font-alt, inherit);" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" required>
                        </div>
                        ...
                        <div class="se-price-breakdown mb-3">
                            <div class="d-flex justify-content-between mb-2 small text-muted">
                                ...
                                <span class="fw-semibold">Rp <?php echo e(number_format($room->roomType->price, 0, ',', '.')); ?></span>
                            </div>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('customer.login')); ?>" class="btn-se btn-se-primary w-100 py-3" style="font-size: 0.95rem; min-height: 52px; border-radius: var(--se-radius-sm); text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px;">
            ...
            <?php if(isset($otherRooms) && $otherRooms->count() > 0): ?>
            <div class="se-booking-sidebar mb-3">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <?php $__currentLoopData = $otherRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('customer.room.detail', $other)); ?>" class="se-similar-room-item">
                            <img src="https://images.unsplash.com/photo-1590490360182-c33d57733427?w=100" alt="Room">
                            <div class="room-info flex-grow-1 min-w-0">
                                <strong class="d-block text-truncate"><?php echo e($other->room_number); ?> - <?php echo e($other->roomType->name ?? 'Standard'); ?></strong>
                                <small><i class="bi bi-people me-1"></i><?php echo e($other->roomType->max_guests ?? '-'); ?> tamu</small>
                                <div class="room-price">Rp <?php echo e(number_format($other->roomType->price, 0, ',', '.')); ?>/malam</div>
                            </div>
...
?>
<?php $__currentLoopData = ['Lobby', 'Restaurant', 'Kolam Renang', 'Gym', 'Garden', 'Parking']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="galleryModal<?php echo e($index); ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border-radius: var(--se-radius);">
            <div class="modal-body p-0">
                <img src="https://images.unsplash.com/photo-<?php echo e($modalImages[$index % 6]); ?>?w=1200"
                     alt="<?php echo e($gallery); ?>"
                     class="w-100"
...
<div class="d-lg-none" style="position: fixed; bottom: 0; left: 0; right: 0; background: var(--se-card); border-top: 1px solid var(--se-border); padding: 12px 16px; z-index: 1000; box-shadow: 0 -4px 20px rgba(0,0,0,0.08);">
    <form action="<?php echo e(route('customer.booking')); ?>" method="POST" id="mobileBookingForm">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="room_id" value="<?php echo e($room->id); ?>">
        ...
        <div class="d-flex gap-2 mb-2">
            <div class="flex-grow-1">
                ...
                <input type="date" name="check_in" id="mobileCheckIn" class="form-control form-control-sm" style="font-size: 0.85rem; border-radius: var(--se-radius-xs);" min="<?php echo e(date('Y-m-d')); ?>" required>
            </div>
            <div class="flex-grow-1">
                ...
                <input type="date" name="check_out" id="mobileCheckOut" class="form-control form-control-sm" style="font-size: 0.85rem; border-radius: var(--se-radius-xs);" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" required>
            </div>
        </div>
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <div style="flex-shrink: 0;">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('customer.login')); ?>" class="btn-se btn-se-primary" style="padding: 10px 24px; font-size: 0.85rem; min-height: 44px; border-radius: var(--se-radius-xs); text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 6px;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const pricePerNight = <?php echo e($room->roomType->price); ?>;
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ukk-hotel-management\resources\views/customer/room-detail.blade.php ENDPATH**/ ?>