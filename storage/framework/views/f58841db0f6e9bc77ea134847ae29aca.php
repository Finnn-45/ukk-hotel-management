<?php $__env->startSection('title', 'Tipe Kamar'); ?>
...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-body p-4">
        ...
        <form method="GET" action="<?php echo e(route('admin.room-types.index')); ?>" class="mb-4">
            <div class="row g-3">
                <div class="col-md-6 col-lg-4">
                    <div class="input-group">
                        <span class="input-group-text bg-white border-end-0"><i class="bi bi-search text-muted"></i></span>
                        <input type="text" name="search" class="form-control border-start-0 ps-0" placeholder="Cari nama tipe kamar..." value="<?php echo e(request('search')); ?>">
                        <button class="btn btn-outline-secondary" type="submit">Cari</button>
                    </div>
                </div>
                <?php if(request('search')): ?>
                    <div class="col-md-2">
                        <a href="<?php echo e(route('admin.room-types.index')); ?>" class="btn btn-outline-danger w-100 rounded-3">Reset</a>
                    </div>
                <?php endif; ?>
            </div>
        </form>
            ...
            <table class="table table-hover align-middle table-custom">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><strong>#<?php echo e($type->id); ?></strong></td>
                            <td>
                                <div class="fw-bold text-dark"><?php echo e($type->name); ?></div>
                            </td>
                            <td>
                                <div class="text-primary fw-semibold">Rp <?php echo e(number_format($type->price, 0, ',', '.')); ?></div>
                            </td>
                            <td>
                                <span class="badge badge-premium badge-premium-info">
                                    <i class="bi bi-people-fill me-1"></i> Max <?php echo e($type->max_guests); ?> Tamu
                                </span>
                            </td>
                            <td>
                                <span class="badge badge-premium badge-premium-secondary">
                                    <i class="bi bi-door-open me-1"></i> <?php echo e($type->rooms_count); ?> Kamar
                                </span>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="<?php echo e(route('admin.room-types.edit', $type)); ?>" class="btn btn-sm btn-outline-warning rounded-3" title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.room-types.destroy', $type)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tipe kamar ini? Semua kamar terkait akan terpengaruh.')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ukk-hotel-management\resources\views/admin/room-types/index.blade.php ENDPATH**/ ?>