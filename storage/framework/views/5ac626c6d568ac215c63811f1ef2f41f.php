<?php $__env->startSection('title', 'Cari Hotel - StayEase'); ?>
            ...
            <div class="se-filter-card">
                ...
                <form method="GET" action="<?php echo e(route('rooms.index')); ?>">
                    ...
                    <div class="se-filter-section">
                        ...
                        <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="room_type" id="ft_<?php echo e($type->id); ?>" value="<?php echo e($type->id); ?>" <?php echo e(request('room_type') == $type->id ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="ft_<?php echo e($type->id); ?>">
                                    <?php echo e($type->name); ?>

                                    <span class="text-muted" style="font-size:0.72rem;">(<?php echo e($type->rooms_count); ?> kmr)</span>
                                </label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="room_type" id="ft_all" value="" <?php echo e(!request('room_type') ? 'checked' : ''); ?>>
                    ...
                    <div class="se-filter-section">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <input type="number" name="min_price" class="form-control form-control-sm" placeholder="Rp 0" value="<?php echo e(request('min_price')); ?>" min="0">
                            </div>
                            <div class="col-6">
                                <label style="font-size:0.72rem;color:var(--text-muted);">Max</label>
                                <input type="number" name="max_price" class="form-control form-control-sm" placeholder="Rp ∞" value="<?php echo e(request('max_price')); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="se-filter-section">
                        ...
                        <?php $facs = [['bi-wifi','WiFi'],['bi-snow','AC'],['bi-tv','TV'],['bi-cup-hot','Sarapan'],['bi-p-square','Parkir']]; ?>
                        <?php $__currentLoopData = $facs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="fac_<?php echo e($loop->index); ?>" disabled>
                                <label class="form-check-label" for="fac_<?php echo e($loop->index); ?>">
                                    <i class="bi <?php echo e($f[0]); ?> me-1"></i> <?php echo e($f[1]); ?>
                    ...
                    <div class="se-filter-section">
                        ...
                        <a href="<?php echo e(route('rooms.index')); ?>" class="btn-filter-reset"><i class="bi bi-arrow-counterclockwise me-1"></i> Reset</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-9">
            ...
            <div class="d-flex d-lg-none align-items-center gap-2 mb-3">
                ...
                <div id="mobileFilterCard" class="se-filter-card d-none" style="position:fixed;top:60px;left:0;right:0;bottom:0;z-index:1000;overflow-y:auto;border-radius:0;background:#fff;width:100%;">
                    <?php echo $__env->make('customer._mobile_filters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
            ...
            <div class="se-results-header">
                <div>
                    <span class="se-results-count"><span><?php echo e($rooms->total()); ?></span> Kamar Ditemukan</span>
                    <?php if(request()->hasAny(['room_type', 'min_price', 'max_price', 'floor'])): ?>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <select class="se-sort-select form-select form-select-sm" style="width:auto;">
                        ...
                        <option value="rating_desc" <?php echo e(request('sort') === 'rating_desc' ? 'selected' : ''); ?>>Rating Terbaik</option>
                    </select>
                </div>
            </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="se-hotel-list-card">
                    ...
                    <div class="se-hotel-list-img">
                        <img src="<?php echo e($img); ?>" alt="Kamar <?php echo e($room->room_number); ?>" loading="lazy">
                        <span class="se-hotel-list-badge"><i class="bi bi-check-circle-fill text-success"></i> Tersedia</span>
                        <span class="se-hotel-list-floor"><i class="bi bi-building me-1"></i>Lt <?php echo e($room->floor); ?></span>
                    </div>

                    
                    <div class="se-hotel-list-info">
                        <div>
                            <div class="se-hotel-list-name"><?php echo e($room->room_number); ?></div>
                            <div class="se-hotel-list-type"><i class="bi bi-tag me-1"></i><?php echo e($room->roomType->name); ?></div>
                            <div class="se-hotel-list-rating">
                                <span class="score"><?php echo e(number_format($score, 1)); ?></span>
                                <div>
                                    <div class="label"><?php echo e($rlabel); ?></div>
                                    <div class="count"><?php echo e($rcount); ?> ulasan</div>
                                </div>
                            </div>
                            <div class="se-hotel-list-stars">
                                <?php for($s=1;$s<=5;$s++): ?>
                                    <?php if($s <= 4): ?><i class="bi bi-star-fill"></i><?php else: ?><i class="bi bi-star-half"></i><?php endif; ?>
                                <?php endfor; ?>
                            </div>
                        </div>
                        <div class="se-hotel-list-amenities">
                            <?php $__currentLoopData = $roomAms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $am): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span><i class="bi <?php echo e($am['icon']); ?>"></i> <?php echo e($am['label']); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <span><i class="bi bi-people"></i> Max <?php echo e($room->roomType->max_guests); ?></span>
                        </div>
                    </div>

                    
                    <div class="se-hotel-list-price">
                        <span class="se-hotel-list-tag"><i class="bi bi-check-circle-fill me-1"></i><?php echo e($tag); ?></span>
                        <div class="se-hotel-list-price-group">
                            <div class="se-hotel-list-price-label">Mulai</div>
                            <div class="se-hotel-list-price-main">Rp <?php echo e(number_format($room->roomType->price, 0, ',', '.')); ?></div>
                            <div class="se-hotel-list-price-sub">per malam</div>
                        </div>
                        <a href="<?php echo e(route('customer.room.detail', $room)); ?>" class="btn-se-hotel-book">
                ...
                <div class="mt-4 d-flex justify-content-center">
                    <nav>
                        <ul class="se-pagination">
                            ...
                            <?php else: ?>
                                <li><a href="<?php echo e($rooms->previousPageUrl() . (request()->except('page') ? '&' . http_build_query(request()->except('page')) : '')); ?>">←</a></li>
                            <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $rooms->getUrlRange(1, $rooms->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <li class="<?php echo e($page == $rooms->currentPage() ? 'active' : ''); ?>">
                                    <?php if($page == $rooms->currentPage()): ?>
                                        <span><?php echo e($page); ?></span>
                                    <?php else: ?>
                                        <a href="<?php echo e($pageUrl); ?>"><?php echo e($page); ?></a>
                                    <?php endif; ?>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                            <?php if($rooms->hasMorePages()): ?>
                                <li><a href="<?php echo e($rooms->nextPageUrl() . (request()->except('page') ? '&' . http_build_query(request()->except('page')) : '')); ?>">→</a></li>
                            <?php else: ?>
                                <li class="disabled"><span>→</span></li>
                            <?php endif; ?>
                        </ul>
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ukk-hotel-management\resources\views/customer/rooms.blade.php ENDPATH**/ ?>