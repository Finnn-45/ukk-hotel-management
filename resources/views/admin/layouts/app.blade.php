...
<head>
    ...
    <title>@yield('title', 'Dashboard') - StayEase Admin</title>
...
<body>
    <div class="sidebar d-none d-md-block">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.restaurant.menu.*') ? 'active' : '' }}" href="{{ route('admin.restaurant.menu.index') }}">
    ...
    <main class="main-content">
        <div class="top-bar">
            ...
            <div class="top-bar-actions">
                <a href="{{ route('home') }}" class="btn btn-sm btn-outline-primary rounded-3" target="_blank">
