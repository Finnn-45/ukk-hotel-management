...
<head>
    ...
    <title>Lupa Password - {{ config('app.name', 'StayEase Hotel') }}</title>
    <meta name="description" content="Reset password akun StayEase Hotel Anda melalui email.">
...
<body>
    <div class="auth-container">
        <div class="auth-hero">
            ...
            <h1>Reset<br><span>Password</span> Anda</h1>
            <p>Tenang, kami akan kirimkan link untuk membuat password baru ke email yang Anda daftarkan.</p>
            <div class="hero-features">
                <div class="hero-feature">
                    <div class="hero-feature-icon"><i class="bi bi-envelope-open-heart-fill"></i></div>
                ...
                <div class="hero-feature">
                    <div class="hero-feature-icon"><i class="bi bi-clock-fill"></i></div>
        ...
        <div class="auth-form">
            ...
            <div class="form-header">
                ...
                <h2>Lupa Password?</h2>
                <p>Masukkan email akun Anda. Link reset password akan dikirimkan ke email tersebut.</p>
            </div>
            @if(session('status'))
            ...
            <form method="POST" action="{{ route('password.email') }}" id="forgotForm">
                ...
                <button type="submit" class="btn-custom" id="submitBtn">
                    ...
                    <span id="submitText"><i class="bi bi-send-fill"></i> Kirim Link Reset Password</span>
                </button>
            </form>
