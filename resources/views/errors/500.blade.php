...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 800; color: #dc3545; line-height: 1; }
        .error-divider { width: 80px; height: 4px; background: #dc3545; margin: 1.5rem auto; border-radius: 2px; }
    </style>
</head>
<body>
