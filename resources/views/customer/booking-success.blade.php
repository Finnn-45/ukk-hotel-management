    ...
    <div class="se-success-card">
        ...
        <div class="se-success-body">
            ...
            <div class="se-booking-number">
                ...
                <div class="se-booking-number-value">#{{ str_pad($booking->id, 6, '0', STR_PAD_LEFT) }}</div>
            </div>
            ...
            <div class="se-details-grid">
                <div class="se-detail-item">
                    ...
                    <p class="se-detail-value">{{ $booking->room->room_number }} - {{ $booking->room->roomType->name }}</p>
                </div>
                <div class="se-detail-item">
                    <div class="se-detail-label">
                    ...
                    <p class="se-detail-value">
                        <span class="se-badge se-badge-warning">{{ ucfirst(str_replace('_', ' ', $booking->status)) }}</span>
                    </p>
                </div>
                <div class="se-detail-item">
                    <div class="se-detail-label">
                    ...
                    <p class="se-detail-value">{{ \Carbon\Carbon::parse($booking->check_in)->format('d M Y') }}</p>
                </div>
                <div class="se-detail-item">
                    <div class="se-detail-label">
                        <i class="bi bi-calendar-event"></i> Check Out
                    </div>
                    <p class="se-detail-value">{{ \Carbon\Carbon::parse($booking->check_out)->format('d M Y') }}</p>
                </div>
                <div class="se-detail-item full-width">
                    <div class="se-total-highlight">
                        <div class="se-total-label">Total Pembayaran</div>
                        <div class="se-total-value">Rp {{ number_format($booking->total_price, 0, ',', '.') }}</div>
                    </div>
                </div>
            </div>
